...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return [_react2.default.createElement(_ToolBar2.default, { key: '0-tool' }), _react2.default.createElement(
        'div',
...
var _ToolBarButton = __webpack_require__(38);
...
var Button = exports.Button = function Button(_ref) {
  var title = _ref.title,
      ...
      icon = _ref.icon;
  return _react2.default.createElement(StyledButton, {
...
var ControlsContainer = _styledComponents2.default.div(_templateObject2);
var Option = _styledComponents2.default.div(_templateObject3, function (props) {
  return props.isSelected ? 'red' : 'black';
});
var GameBanner = _styledComponents2.default.div(_templateObject4);
var HideInPhoneImg = _styledComponents2.default.img(_templateObject5);
...
var MainMenu = function (_Component) {
  ...
  function MainMenu(props) {
    ...
    _this.options = ['play', 'options', 'quit'];
    return _this;
  }
  ...
  _createClass(MainMenu, [{
    ...
    value: function handleUpArrow() {
      ...
      this.setState(function (prev) {
        if (prev.optionSelected === 0) {
          optionSelected = _this2.options.length - 1;
        } else {
    ...
    value: function handleDownArrow() {
      ...
      var optionSelected = void 0;
      this.setState(function (prev) {
        if (prev.optionSelected === _this3.options.length - 1) {
          optionSelected = 0;
        } else {
          optionSelected = prev.optionSelected + 1;
        }
    ...
    key: 'onOptionClick',
    value: function onOptionClick(index) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(HideInPhoneImg, { src: 'images/falabracman.png' }),
            _react2.default.createElement('img', { src: 'images/menu_sprite.png', height: 150 })
          )
        ),
        _react2.default.createElement(
          ControlsContainer,
          { inner: true, Ref: function Ref(controlsContainer) {
              _this4.controlsContainer = controlsContainer;
            } },
          _react2.default.createElement(
            'div',
            null,
            this.options.map(function (option, index) {
              return _react2.default.createElement(
                Option,
                {
                  isSelected: _this4.state.optionSelected === index,
                  key: index,
                  onClick: _this4.onOptionClick.bind(_this4, index)
                },
                option
              );
            })
